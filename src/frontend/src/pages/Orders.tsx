...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-border px-4 sm:px-6 py-4 flex items-center gap-3 sticky top-0 z-40">
        <div className="w-9 h-9 rounded-full bg-primary flex items-center justify-center">
          <ChefHat className="w-5 h-5 text-primary-foreground" />
        </div>
        <div className="flex-1">
          <h1 className="font-display font-700 text-base">My Orders</h1>
          <p className="text-xs text-muted-foreground">Swaad Wallah Sandwich</p>
        </div>
        <a
          href="/"
